 ...
 * common to Apache Geode and Pivotal GemFire in order to manage HTTP Session state.
 *
 * @author John Blum
 * @see ClassLoader
 ...
 * @see Environment
 * @see SpringHttpSessionConfiguration
 * @since 2.0.4
 */
@SuppressWarnings("unused")
public abstract class AbstractGemFireHttpSessionConfiguration
		implements BeanClassLoaderAware, EnvironmentAware, ApplicationContextAware {
